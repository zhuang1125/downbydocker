...
RUN  mkdir /data && cd /data && wget https://download.microsoft.com/download/4/3/B/43B61315-B2CE-4F5B-9E32-34CCA07B2F0E/NDP452-KB2901951-x86-x64-DevPack.exe  && wget https://go.microsoft.com/fwlink/?linkid=397673&clcid=0x409
